...
<html lang="en">
<head>
    <title>Inicio - MODX Revolution</title>
    <base href="[[!++site_url]]" />
    <meta charset="UTF-8" />
    ...
    <style type="text/css">
        ...
        .logo {
            background: url(\'/modx/manager/templates/default/images/modx-logo-color.svg\') no-repeat center transparent;
            width: 220px;
            height: 85px;
...
<div class="container">
    <section>
        ...
        <p>You have successfully installed MODX Revolution&nbsp;2.7.3-pl!</p>
<p>Now that MODX is installed you can login to the manager to create your templates, manage content and install third party extras to add functionality to your&nbsp;website. </p>
...
<p>To learn more about MODX, be sure to check out the <a href="https://rtfm.modx.com/revolution/2.x/getting-started">Getting Started</a> section in the official&nbsp;documentation.</p>
    ...
    <aside>
        <a href="/modx/manager/" title="Your MODX manager" class="cta-button">Go to the&nbsp;manager</a>
...
',
  ...
  array (
    '[[*pagetitle]]' => 'Inicio',
    '[[*longtitle:default=`Inicio`]]' => 'Congratulations!',
  ),
  'sourceCache' => 
  array (
    'modChunk' => 
